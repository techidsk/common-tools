...
async def create_service_config(config: ProcessingConfig) -> ServiceConfig:
    ...
    return ServiceConfig(
        ...
        workflow_path=Path(r"modules\comfyui\workflows\bjh_flush_0401_api.json"),
...
async def main() -> None:
    ...
    tasks = [
        ProcessingConfig(
            target_folder=Path(r"D:\ftp\客户素材\B-百家好\20250401_街拍图"),
            node_config_path=Path(r"modules\comfyui\workflows\bjh_flush_0401_config.json"),
